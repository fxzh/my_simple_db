...
DB_RAISE(ErrCode, MODULE, "{}", ...)    // common/err.h：源头报错，记 ERROR 日志并抛 DbError

# 行为要点
- LogLevel: DEBUG5~CRITICAL；LogModule: SYNTAX/PARSER/ANALYZER/PLANNER/EXECUTOR/NETWORK/SYSTEM/STORAGE/CATALOG/GENERAL
- ERROR 及以上附带 Boost.Stacktrace 堆栈；log() 无 throw/exit 副作用，落地报错走 common/err.h 的 DB_RAISE
